...
<p class="sub" style="margin-top: 15px;">Thank you for registering for the Workshops & Process Safety by Frontline pass at the <a href="{{ $details['eventLink'] }}" target="_blank">{{ $details['eventName'] }}</a>, taking place on 29 September 2026 at Jubail University City, Saudi Arabia.</p>
