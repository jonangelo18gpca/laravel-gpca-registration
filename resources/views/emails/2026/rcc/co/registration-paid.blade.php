...
<p class="sub" style="margin-top: 15px;">Thank you for registering to attend the <a href="{{ $details['eventLink'] }}" target="_blank">{{ $details['eventName'] }}</a>, taking place from 29 September - 01 October 2026 at the Jubail University City, By registering as a delegate, your participation is subject to the terms and conditions outlined in your invoice.</p>

<p class="sub" style="margin-top: 15px;">We are pleased to confirm your registration and successful payment for the event. Your delegate pass is valid for the <strong><i>Conference only. </i></strong>Please find below the summary of your booking details.</p>
