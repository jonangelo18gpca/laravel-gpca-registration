...
<p class="sub" style="margin-top: 15px;">Thank you for registering to attend the <a href="{{ $details['eventLink'] }}" target="_blank">{{ $details['eventName'] }}</a>, taking place from 29 September - 01 October 2026 at the Jubail University City, Saudi Arabia. By registering as a delegate, your participation is subject to the terms and conditions outlined in your invoice.</p>

<p class="sub" style="margin-top: 15px;">Your registration has been confirmed. You will have access to the Workshops & Process Safety by Frontline on 29th September, as well as the conference discussions and exhibition floor from 30 September – 01 October. During the event, you will also have access to the Gala Dinner and networking opportunities throughout the event. Please find below the summary of your booking registration.</p>
