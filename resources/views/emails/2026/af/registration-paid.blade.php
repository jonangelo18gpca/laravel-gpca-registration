...
<p class="sub" style="margin-top: 15px;">Thank you for registering to attend the <a
    ...
    subject to the terms & condition.</p>

<p class="sub" style="margin-top: 15px;"><strong>Please note that your registration is confirmed, and summary of
        your booking confirmation is given below.</strong></p>
...
<p class="sub" style="margin-top: 15px;">To request any updates on your registration details, kindly contact
<a href="mailto:jovelyn@gpca.org.ae">jovelyn@gpca.org.ae</a> before 30th October to ensure your badge
